define({
    root:({
        ...
        recordingAlert: "There were no Cycloramas found in the area. Please center the map on an area with Cycloramas or click on a Coverage Map area and try again.",
